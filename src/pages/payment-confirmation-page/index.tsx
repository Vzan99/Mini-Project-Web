  ...
  return (
    <div className="bg-[#FAF0D7] min-h-screen py-8">
      <div className="container mx-auto px-4 max-w-2xl">
        <h1 className="text-3xl font-bold mb-6 text-[#222432]">Payment Confirmation</h1>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Attend date: {formatDate(transaction.attendDate)}</p>
                </div>
              </div>
              ...
              <div className="border-t border-gray-200 pt-4 mt-2">
                <div className="flex justify-between mb-2">
                  <span>Tickets</span>
                  <span>{transaction.quantity} × {formatNumberWithCommas(event.price)}</span>
                </div>
                
                {transaction.voucherCode && (
                  <div className="flex justify-between text-green-600 mb-2">
                    <span>Voucher</span>
                    <span>-{formatNumberWithCommas(transaction.totalPrice - (event.price * transaction.quantity))}</span>
                  </div>
                )}
                ...
                {transaction.pointsUsed > 0 && (
                  <div className="flex justify-between text-green-600 mb-2">
                    <span>Points</span>
                    <span>-{formatNumberWithCommas(transaction.pointsUsed)}</span>
                  </div>
                )}
